        ...
        function get_query_param(param) {
          ...
          window.location.search.split("?")[1].split("&").forEach(function(d) {var m = d.split("="); urlKeyValuePairs[m[0]] = m[1] })
        ...
        function init(json_string) {
          ...
          stream2packetsArray.sort(function(a,b){return stream2packetsDict[b].values.length - stream2packetsDict[a].values.length})
          ...
          to_plot.forEach(function(d){add_scale(d, y_range)});
        }
        ...
        function draw() {
          ...
          to_plot.forEach(function(d){visualize(d)})
